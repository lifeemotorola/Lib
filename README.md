...
Education, Biology, Chemistry and Economics**, Grades 1–12, all
A4-exact on screen, in print and in Word.
...
- **10 subjects** with real curriculum content (6 units per grade per subject)
...
| **Subject** | One of the 10 subjects; Biology/Chemistry/Economics reuse the Science/Social Studies engines. |
...
> Chemistry and Economics; the other subjects stop at Grade 9.
...
| `gen-*.js` | Exercise-generation engines per subject (some share an engine, e.g. `bi`/`ch` use `gen-sc.js`). |
