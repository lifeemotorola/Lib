...
- **Study notes** for every unit: key ideas, worked examples and common
  mistakes — and for Social Studies, General Science, English and Mathematics
  Grades 1–9, plus French Grades 7–9, the full **course text**, transcribed
...
- A unit may also carry `study[]` — a block list (`h3`/`p`/`bul`/`num`/`rule`,
  ...
  English and Mathematics, Grades 1–9 (54 units each), and French,
  Grades 7–9 (18 units), carry full verbatim notes derived from their
