...
- **Study notes** for every unit: key ideas, worked examples and common
  mistakes — and for Social Studies, General Science and English Grades 1–9,
  plus Mathematics and French Grades 7–9, the full **course text**, transcribed
  verbatim from the official curriculum guide
...
- A unit may also carry `study[]` — a block list (`h3`/`p`/`bul`/`num`/`rule`,
  ...
  and English, Grades 1–9 (54 units each), and Mathematics and French,
  Grades 7–9 (18 units each), carry full verbatim notes derived from their
  curriculum guides, with the guide page range of each unit recorded in a
  comment above its list; the remaining subjects fall back to the
  auto-assembled page.
