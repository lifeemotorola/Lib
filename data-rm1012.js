/* Curriculum data — Republic of Liberia, Senior High RELIGIOUS & MORAL
   ...
   Grades 1–9 files. Scripture references are retained as text references
   only. Per the project rule, no online resources are referenced anywhere:
...
/* ================================ GRADE 10 ================================ */
{
  ...
  study:[
    ...
    {k:"p", t:"An <b>attribute</b> is something true about God's nature. The three traditions of Liberia teach these attributes of the Creator:"},
    ...
    {k:"p", t:"<b>General revelation</b> is God making Himself known to all people through creation and conscience: \"The heavens declare the glory of God\" (Psalm 19:1); \"His invisible nature has been clearly perceived in the things that have been made\" (Romans 1:20); \"We shall show them Our signs in the horizons and in themselves\" (Qur'an 41:53). <b>Special revelation</b> is God making Himself known in a particular way: in the Holy Scriptures, in the prophets, and, for Christians, in Jesus Christ His Son."},
    {k:"rule"},
    {k:"h3", t:"The Problem of Evil"},
    {k:"p", t:"If God is all-good and all-powerful, why does He allow suffering? This is the <b>problem of evil</b>, and every mature believer must face it honestly. The traditions answer:"},
    {k:"bul", items:[
...

{
  ...
  study:[
    ...
    {k:"p", t:"<b>Religious authority</b> is the right and power to say what is true and what must be done. In each tradition authority flows from God Himself, and it is carried by the sources He has given: holy books, holy persons and the voice He placed within the human heart. Where the sources disagree with a person's wishes, the believer submits to the sources — that is what makes the authority real."},
    {k:"rule"},
    {k:"h3", t:"The Holy Bible"},
    {k:"p", t:"The Holy Bible is the Christian scriptures: <b>sixty-six books</b>, written by many authors over many centuries, gathered into two testaments. The <b>Old Testament</b> (39 books) holds the Law, the histories, the Psalms and wisdom, and the Prophets. The <b>New Testament</b> (27 books) holds the four Gospels, the Acts of the Apostles, the Epistles and the Revelation. Christians believe the scriptures are \"God-breathed and profitable for teaching, for reproof, for correction and for training in righteousness\" (2 Timothy 3:16-17), and call the word \"a lamp to my feet and a light to my path\" (Psalm 119:105)."},
...

{
  ...
  study:[
    ...
    {k:"p", t:"<b>Worship</b> is the response of the whole person to the worth of God — adoration, thanksgiving, confession, petition and service. It is due to God alone; the angels refuse worship for themselves, and the traditional priest directs honour past the ancestors to the Creator. Worship is both <b>private</b> — the believer alone with God — and <b>corporate</b> — the community gathered in one place and one voice."},
    {k:"rule"},
    ...
    {k:"p", t:"Offering is worship with the hands. The Christian gives the <b>tithe</b> and the freewill offering — \"God loves a cheerful giver\" (2 Corinthians 9:7). The Muslim gives <b>zakat</b>, the purifying due on wealth, one of the five pillars, and <b>sadaqah</b>, voluntary charity — \"whatever good you spend, it will be repaid to you in full\" (Qur'an 2:272). The traditional community gives the <b>first fruits</b> at harvest and contributes the communal labour that roofs a neighbour's house. Giving honours God by declaring that all we have is His."},
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:[
...

{
  ...
  study:[
    ...
    {k:"p", t:"Marriage is a <b>covenant</b> — a promise made before God and the community — not a private experiment. The traditions give its purposes:"},
    {k:"bul", items:[
...

{
  ...
  study:[
    ...
    {k:"p", t:"Senior high is the seed-bed of vocation: the subjects studied, the trades observed, the habits formed. The learner should ask three questions early: <b>What can I do well?</b> (gift and skill), <b>What does my community need?</b> (service), and <b>What has God put in my heart?</b> (calling). Where the three answers meet, there is a vocation worth preparing for — by study, apprenticeship, discipline and prayer."},
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:[
...
/* ================================ GRADE 11 ================================ */
{
  ...
  study:[
    ...
    {k:"p", t:"<b>Conscience</b> is the inner sense of right and wrong that passes judgment on our own thoughts and acts — before, during and after. Paul writes that the law of God is written on human hearts, \"their conscience also bearing witness, and their thoughts accusing or else excusing them\" (Romans 2:14-15). The Qur'an swears by the soul and what God inspired in it \"of its wickedness and its righteousness\" (Qur'an 91:7-10). The elders call it the <b>small voice</b> that speaks loudest at night. Conscience is a witness, not a lawgiver: it reports; it must itself be taught what is true."},
    {k:"rule"},
    ...
    {k:"p", t:"And how it is <b>deformed</b>: by repeated small compromises (each lie makes the next easier), by crowds that shout down the small voice, by self-interest that argues until wrong looks right, and by guilt long refused, which sears the witness as a hot iron sears skin."},
    {k:"rule"},
    {k:"h3", t:"The Steps of Moral Decision-Making"},
    {k:"num", items:[
      "<b>Name the question.</b> What exactly must be decided, and who will be affected?",
      "<b>Gather the facts.</b> What is true? What is assumed? Half of all bad choices are made on bad information.",
      "<b>Consult the sources.</b> What do the scriptures, the tradition and the lawful authority say? Has a teacher of your tradition met this before?",
      "<b>Weigh the options.</b> Test each by three questions: Is it right in itself? Is it right in its fruits? What motive pushes it?",
      "<b>Pray.</b> Ask God for light and courage — the traditions agree that the decision made kneeling is kept standing.",
      "<b>Choose and act.</b> Do the right, promptly and fully.",
      "<b>Review.</b> Reckon honestly: thank God where it was kept right; repent and repair where it was not."
    ]},
    {k:"rule"},
...

{
  ...
  study:[
    ...
    {k:"p", t:"<b>Justice</b> is giving each person what is due to them — the worker the wage, the accused the hearing, the weak the protection, God the obedience. The Bible: \"He has shown you, O man, what is good... to do justice, and to love kindness, and to walk humbly with your God\" (Micah 6:8). The Qur'an: \"Be steadfast witnesses for Allah in justice, and let not hatred of a people move you from justice; be just — that is nearer to godliness\" (Qur'an 5:8). The elders' palaver is the sitting of justice: every voice is heard, the small and the great alike."},
    {k:"rule"},
    ...
    {k:"p", t:"<b>Tolerance</b> is not the pretence that all religions are the same — each tradition holds its convictions, and honesty honours that. Tolerance is the refusal to persecute, mock or marginalise a person for their faith, and the readiness to live, work and build the nation together. Its disciplines:"},
    {k:"num", items:[
...

{
  ...
  study:[
    ...
    {k:"p", t:"The traditions judge leadership by one test: whom does the leader serve? Christ overturned the model of the nations — \"whoever would be first among you must be slave of all. For the Son of Man came not to be served but to serve\" (Mark 10:44-45), and He washed the disciples' feet to make it plain (John 13:13-15). The Prophet Muhammad ruled Medina and still mended his own sandals, and said that the leader of a people is their servant. The chief in the tradition is the <b>father of the town</b>: he eats last, the town's case is his own case, and his honor is the people's welfare. Authority, in all three, is a <b>trust</b> (amanah) — the Qur'an commands: \"Allah commands you to render trusts to whom they are due, and when you judge between people, to judge with justice\" (Qur'an 4:58)."},
    {k:"rule"},
...

{
  ...
  study:[
    ...
    {k:"p", t:"Two errors stand against this ministry: the error of <b>despair</b>, which treats the sick as already dead and abandons them; and the error of <b>exploitation</b>, which preys on the sick — selling false cures, blaming the innocent, or holding \"miracle\" fees over the desperate. Both are condemned."},
    {k:"rule"},
...

{
  ...
  study:[
    ...
    {k:"bul", items:[
      "The body dies; the soul goes to God; the body awaits the <b>resurrection</b> at the last day (1 Corinthians 15)",
      "<b>Judgment</b> follows death — the deeds done in the body are judged (2 Corinthians 5:10)",
      "<b>Heaven</b> is the Father's house: \"I go to prepare a place for you\" (John 14:1-3); the new heaven and the new earth, where God wipes away every tear (Revelation 21:1-4)",
      "<b>Hell</b> is the far country from God — the rich man who ignored Lazarus found it (Luke 16:19-31)",
    ...
    {k:"bul", items:[
      "At death the soul is taken by the angel; the grave is the first stage (<b>barzakh</b>) where the soul is questioned",
      "The <b>Day of Resurrection</b> (Yawm al-Qiyamah) — the trumpet sounds and all are raised (Qur'an 99)",
      ...
      "<b>Paradise</b> (Jannah) is the garden beneath which rivers flow, the home of peace; <b>hell</b> (Jahannam) is the fire prepared for the stubborn in evil",
    ...
    {k:"bul", items:[
      "Death is a <b>transition</b>, not an extinction — the person joins the ancestors, the living-dead, from whom the community still draws counsel",
      "The spirit <b>returns to the Creator who gave it</b>, as the elder's word parallels Ecclesiastes 12:7",
      "The funeral is an <b>escort</b> — the community accompanies the spirit home with rites, and the libation maintains the bond",
      "The ancestors are honoured with remembrance and consultation; some traditions teach the spirit's <b>return</b> in new life — the elders teach it variously among Liberia's peoples",
...

{
  ...
  study:[
    ...
    {k:"p", t:"Science asks <b>how</b> the world works — and answers with mechanisms, tested by experiment. Religion asks <b>why</b> there is a world at all, what it means, and how we ought to live in it — and answers with faith, tested by obedience. A mechanism and a meaning are not rivals: the rain's physics and the rain's Giver are two sentences about one shower. The believer scientist studies creation as a person studies a letter — its paper and its words."},
    {k:"bul", items:[
    ...
    {k:"p", t:"On the reading of Genesis, Christians hold various faithful views — the six days read as days, as ages, or as a liturgical framework — and the Church has long taught that the Bible teaches <b>who</b> created and <b>why</b>, leaving the <b>how</b> to be studied in God's book of works. Humility belongs to both sides: the scientist who says \"there is no Giver\" has left science for philosophy, and the believer who fears the telescope has forgotten who made what it sees."},
    {k:"rule"},
    ...
    {k:"num", items:[
      "<b>Life is God's</b> — to be protected from conception to the grave; no tradition licenses the destruction of the innocent",
      "<b>Love of neighbour</b> — the sick are owed care regardless of purse, tribe or creed",
      "<b>The body is a trust</b> — treatment is received thankfully: the drug taken as prescribed, the clinic visited early, vaccination welcomed as protection of the body and the neighbour's children alike",
      "<b>Truthfulness</b> — the patient deserves honest counsel; the healer and the doctor are both bound by it"
    ]},
    ...
    {k:"bul", items:[
      "<b>Dishonesty</b> — the scam message, the false identity, the fake invoice; \"you shall not bear false witness\" (Exodus 20:16) applies to the forwarded claim; \"if a wicked person brings you news, verify it\" (Qur'an 49:6)",
      "<b>Impurity</b> — the screen serves lust on request; the traditions guard the eyes and the heart (Matthew 5:28; Qur'an 24:30 — \"tell the believing men to lower their gaze\")",
      "<b>Addiction and waste</b> — hours and data swallowed; the steward's question — what did the night of scrolling produce?",
      "<b>Cruelty</b> — cyberbullying, the mocked picture, the rumour started in a group chat; the tongue's fire is now a thumb's (James 3:5-6)",
      "<b>Examination malpractice</b> — the leaked paper forwarded; the same theft and false witness as on paper",
      "<b>The stranger's danger</b> — the child lured, the girl deceived; parents' oversight is part of the command to train up a child"
    ]},
    {k:"rule"},
...
/* ================================ GRADE 12 ================================ */
{
  ...
  study:[
    ...
    {k:"bul", items:[
      "The <b>one Creator</b>, almighty, all-knowing, holy, merciful, the Judge of all",
      "<b>Prayer</b> — in all three, the believer speaks with God and listens",
      "<b>Honesty, justice, mercy, hospitality, faithfulness, respect for elders and parents</b> — the moral core all three command",
      "The <b>dignity of the person</b> and the <b>duty to the poor</b> — the widow and the orphan are the test in all three",
      "The <b>accountability of every soul</b> to God at the end"
    ]},
    {k:"rule"},
    {k:"h3", t:"The Real Differences"},
    {k:"p", t:"Respect does not hide differences; it states them fairly. The chief differences: the person of <b>Jesus Christ</b> — Christianity's Son of God and Saviour; Islam's honoured prophet, but not divine; and in the tradition, a great healer and teacher among the religions' guests. The <b>Trinity</b> and <b>Tawhid</b> — the deepest divergence of formulation. The <b>sources</b> — book against book against memory. The <b>ancestors</b> — the tradition's living-dead, whom Christianity and Islam remember but do not consult. Each community holds its differences dear; the rule of dialogue is to state the difference as the other community itself states it, and no further."},
    {k:"rule"},
    {k:"h3", t:"What Dialogue Is and Is Not"},
    {k:"bul", items:[
      "Dialogue <b>is</b> talking to understand — asking, listening, checking, thanking",
      "Dialogue <b>is</b> honest witness — a believer may say plainly what he believes and why, with courtesy",
      "Dialogue <b>is not</b> debate for victory — the aim is a true meeting, not a surrendered opponent",
      "Dialogue <b>is not</b> syncretism — blending the faiths into one grey mixture pleases no one and answers nothing",
      "Dialogue <b>is not</b> relativism — \"it is all the same\" insults every community that died for its difference",
      "Dialogue <b>is not</b> a plot — the interfaith table is not a trap for conversion but a table for truth, peace and shared work"
    ]},
    {k:"rule"},
    {k:"h3", t:"The Disciplines of Dialogue"},
    {k:"num", items:[
      "<b>Represent truly</b> — state the other's faith as its own people state it; never the parody",
      "<b>Listen fully</b> — to the end, without preparing the rebuttal while the other speaks",
      "<b>Ask, don't accuse</b> — \"help me understand how your community reads this\" opens what an accusation closes",
      "<b>Own your own</b> — confess your own community's failures where they are real; it earns the right to ask questions",
      "<b>Find the shared work</b> — the clinic, the school, the clean-up, the peace; doctrine is discussed best side by side with service",
      "<b>Keep the relationship</b> — the dialogue partner of today is the neighbour of tomorrow; win the person, not the argument"
    ]},
    {k:"rule"},
...

{
  ...
  study:[
    ...
    {k:"p", t:"Peter asked how many times he must forgive — seven? Jesus answered, <b>seventy times seven</b> (Matthew 18:21-22): forgiveness is a way of life, not a loan. The Qur'an sets it higher still: \"the recompense of an evil is its like, but whoever pardons and makes reconciliation, his reward is with Allah\" (Qur'an 42:40); \"repel evil with what is better, and your enemy will become as a devoted friend\" (Qur'an 41:34). The tradition's reconciliation rites seat the parties, name the wrong, pay what can be paid, and restore the relationship to the community."},
    {k:"p", t:"What forgiveness is <b>not</b>: it is not pretending the wrong never happened; it is not abandoning justice (the killer still answers to the law); it is not reconciliation forced on the weaker party; and it is not re-traumatising the victim with demands to \"forget\". Forgiveness releases the victim from the debt's grip; justice orders the wrong; reconciliation — where possible — restores the future."},
    {k:"rule"},
    ...
    {k:"num", items:[
      "<b>Listen to the end</b> — most conflict escalates because no one was heard",
      "<b>Cool the words</b> — refuse hate speech, rumour and the mocking name; a war of words feeds the war of hands",
      "<b>Mediate, don't judge</b> — seat the parties, name the facts, seek the settlement, keep the relationship",
      "<b>Act early</b> — the small case settled today is the big case prevented next year",
      "<b>Work for justice</b> — peace without justice is a ceasefire of the mouth; drain the fuels",
      "<b>Stay in the room</b> — the peacemaker's chief weapon is presence that will not leave"
    ]},
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:[
...

{
  ...
  study:[
    ...
    {k:"bul", items:[
      "<b>The sacred grove</b> — a forest never cut, where the community meets its spirits and its ancestors; whole ecosystems survived in Liberia because the grove was holy",
      "<b>The totem taboo</b> — the clan that may not eat or kill its totem animal guards that species everywhere; the leopard, the python and the hornbill have clans that shield them",
      "<b>The closed season</b> — the river not fished on its days, the bush not entered in its season, the farm given its fallow years",
      "<b>The settled boundary</b> — land cases heard by the palaver, because a boundary settled by justice outlasts one settled by fire"
    ]},
    {k:"rule"},
    {k:"h3", t:"Liberia's Environment — the Trust Today"},
    {k:"bul", items:[
      "<b>The rainforest</b> — Liberia holds one of West Africa's last great rainforests; its destruction by logging, shifting cultivation and charcoal is the trust spent in one generation",
      "<b>Mining and its scars</b> — iron ore, gold and diamonds feed the nation but poison rivers and leave pits where farms and towns stood, when done without care",
      "<b>Water and waste</b> — the plastic-filled creek, the unclean well, the fish killed downstream of the effluent",
      "<b>Wildlife</b> — the bushmeat trade emptying the forest of its animals, species by species",
      "<b>Climate change</b> — the rains that no longer keep their calendar, the dry-season harmattan growing harsher, the sea eating at the coast — the poor farmer meets it first"
    ]},
    {k:"rule"},
    ...
    {k:"p", t:"Environmental harm is not shared fairly: the poor live by the poisoned creek, farm the eroding hill and fetch water from the river the mine turns brown; the unborn inherit the pit and the lost forest. The traditions' rule of justice — the widow, the orphan, the stranger — extends across time: <b>the children yet unborn are neighbours with a claim on our conduct</b>. \"A good man leaves an inheritance to his children's children\" (Proverbs 13:22) — and the inheritance is soil, forest and clean water before it is money."},
    {k:"rule"},
...

{
  ...
  study:[
    ...
    {k:"p", t:"The online version adds the voice note's \"man of God\" and the WhatsApp \"prayer fee\" — the same tactics at the speed of the network. The rule holds: <b>verify</b> (Qur'an 49:6), <b>test</b> (1 John 4:1), <b>ask the elders</b>."},
    {k:"rule"},
    {k:"h3", t:"The Occult — Its Dangers"},
    {k:"p", t:"The traditions teach a real spiritual world, and a real forbidden side of it. The occult promises power, wealth or revenge through juju, secret rituals, oaths and blood — and the traditions answer with one voice: the power sought outside God binds the seeker. Scripture forbids sorcery and consulting the dead (Deuteronomy 18:10-12); the Qur'an seeks refuge from \"the whisperers\" and the evil of what He created (Qur'an 113-114); the elders themselves warn that the medicine of destruction returns on the hand that sends it. And some of what is called spiritual is simply crime: <b>ritual killing is murder under the law of Liberia and an abomination before every tradition</b>. The young person is warned, protected and told: report to parents and elders what offers you power at a price."},
    {k:"rule"},
    {k:"h3", t:"Witchcraft Accusations — the Cruel Inversion"},
    {k:"p", t:"The other face of the occult danger is the <b>accusation</b>: children, widows, the old and the disabled branded witches, driven out, beaten or \"delivered\" for fees. The traditions' own teaching condemns the cruelty: the innocent must not be condemned without proof — \"one witness is not enough\" (Deuteronomy 19:15; the Qur'an's evidences and the elders' inquiry likewise); Jesus refused the crowd's accusations and protected the accused; and the law of Liberia criminalises the assault that hides behind the label. Where a child is accused, the community's duty is protection, inquiry and care — not the mob."},
    {k:"rule"},
    {k:"h3", t:"The Disciplines of Discernment"},
    {k:"num", items:[
      "<b>Know the source yourself</b> — the Bible or the Qur'an read daily; the impostor rules the biblically illiterate",
      "<b>Ask questions early</b> — about money, about accountability, about the teaching; the true teacher welcomes the Berean test",
      "<b>Consult your elders</b> — parents, pastor or imam, and the town elders; the lone believer is the easy mark",
      "<b>Refuse secrecy</b> — what cannot be told to your mother is not of God",
      "<b>Watch the fruit over time</b> — one service proves nothing; a year of followers' lives proves much",
      "<b>Report exploitation</b> — to parents, to the religious council, and where crime is done, to the authorities"
    ]},
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:[
...

{
  ...
  study:[
    ...
    {k:"num", items:[
      "<b>Integrity</b> — the same person in the dark; the bribe refused at the first offering, when refusal is cheapest",
      "<b>Self-discipline</b> — the governed day: devotion, work, study, rest; the traditions train the will by prayer, fasting and faithful hours",
      "<b>Purity as adult conviction</b> — the chastity learned in Grade 9 now owned, not merely obeyed; the body kept as God's temple (1 Corinthians 6:19-20)",
      "<b>Financial discipline</b> — earn honestly, save regularly, give faithfully, owe cautiously; the tithe, zakat and the budget are one habit",
      "<b>Lifelong learning</b> — the graduate who stops learning starts declining; the Qur'an's first revealed word was <b>Read</b> (Qur'an 96:1)",
      "<b>Hope and perseverance</b> — \"by time, surely man is in loss, except those who believe and do good works, and counsel one another to truth and counsel one another to patience\" (Qur'an 103)"
    ]},
    {k:"rule"},
    {k:"h3", t:"The Works of Nation-Building"},
    {k:"bul", items:[
      "<b>The vote at eighteen</b> — cast for character and plan, not county or pocket; the vote is a trust before God",
      "<b>Service</b> — the community clean-up, the teaching of juniors, the health campaign, the volunteer firebreak; nation-building is mostly unpaid work",
      "<b>Skills</b> — agriculture, health, education, trades and technology; a nation cannot import its own future",
      "<b>The honest economy</b> — pay the tax, keep the scale true, register the business; the honest trader builds more than the eloquent politician",
      "<b>The refusal of tribalism</b> — \"nations and tribes that you may know one another\" (Qur'an 49:13); the graduate who marries, hires and befriends across lines builds the Liberia the founders imagined",
      "<b>Peace kept</b> — the peacemaker's skills carried into adult life; the rumour refused, the case settled early"
    ]},
    {k:"rule"},
    {k:"h3", t:"Mentorship — Passing It On"},
    {k:"p", t:"Values survive only when passed hand to hand. The graduate's duty runs both directions: <b>upward</b>, to seek the counsel of elders while they remain (\"the death of an old person is the burning of a library\"); and <b>downward</b>, to take a younger learner by the hand — the Sunday school class, the Qur'an lesson, the coaching of a junior's mathematics, the telling of the proverbs. The tradition's picture is the compound: every adult is somebody's elder, and every child is the whole town's child."},
    {k:"rule"},
    {k:"h3", t:"Faith in Adulthood"},
    {k:"p", t:"Childhood faith is a gift of the family; adult faith is a possession of the person. The graduate joins the adult fellowship, keeps a personal devotion that survives the new schedule, and expects the testing of convictions — in the workplace, the market and the compound. The workplace witness is mostly silent and mostly powerful: <b>the honest clerk, the punctual nurse, the trader whose word is trusted</b>. When faith costs — the refused bribe, the mocked purity, the honest price that loses the sale — the traditions count the cost as gain: \"whoever loses his life for My sake will find it\" (Matthew 16:25)."},
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:[
...

{
  ...
  study:[
    ...
    {k:"p", t:"The spiral's centre has never moved: <b>God, the neighbour, the self — in that order</b>. Every theme of twelve years is one of these three, or the road between them."},
    {k:"rule"},
    {k:"h3", t:"The Character of a Life Well Lived"},
    {k:"bul", items:[
      "<b>The golden rule</b> — \"whatever you wish that others would do to you, do also to them\" (Matthew 7:12); the Hadith: none of you truly believes until he wishes for his brother what he wishes for himself",
      "<b>Faithfulness in small things</b> — \"one who is faithful in a very little is faithful also in much\" (Luke 16:10); the returned nail and the true measure",
      "<b>Perseverance</b> — \"let us not grow weary of doing good, for in due season we will reap\" (Galatians 6:9); Qur'an 103's counsel to patience",
      "<b>Honesty kept expensive</b> — the name kept when the shortcut was cheaper",
      "<b>Love that costs</b> — the Samaritan's oil and the two coins of the widow (Luke 10:33-35; Mark 12:44)",
      "<b>Hope</b> — the final chapters of every tradition end in home: the Father's house, the garden, the ancestors' welcome"
    ]},
    {k:"rule"},
    {k:"h3", t:"The Personal Code"},
    {k:"p", t:"A <b>personal code</b> is the graduate's own law, written in his own hand from the twelve years' teaching. It is short — five to eight lines — because a code kept must be memorised. Each line names a value and its practice. And a code has <b>accountability</b>: one or two named persons — an elder, a friend of the same faith — who may ask, and must be answered."},
    {k:"num", items:[
