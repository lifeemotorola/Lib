...
/* ================================ GRADE 7 ================================ */
{
  ...
  study:[
    /* ---- course text: Semester One, Period I — Reconciliation (pages 2-3) ---- */
    {k:"h3", t:"The Concept of Reconciliation"},
    {k:"p", t:"**Reconciliation** is the restoring of a broken relationship so that the parties are at peace again. Learners approach the topic from a **multi-religious standpoint**, taking into consideration the various biases and nuances of a multi-religious society: reconciliation of **God to man**, **man to God** and **man to man**."},
    {k:"rule"},
    {k:"h3", t:"Reconciliation of Man to God"},
    {k:"p", t:"Sin breaks the relationship between man and God. **Reconciliation of man to God** is the restoring of that relationship: man repents, turns from sin, and is forgiven and accepted back by God. Scripture references: the Holy Bible, Daniel 9:24, 2 Corinthians 5:18-19 and Hebrews 2:17; the Holy Qur'an teaches that God is Oft-Forgiving and Most Merciful."},
    {k:"rule"},
    {k:"h3", t:"Reconciliation of Man to Man"},
    {k:"p", t:"**Reconciliation of man to man** is the restoring of peace between people: between friends, family members, neighbours, tribes and nations. Scripture references: the Holy Bible, Matthew 5:24 — be reconciled to your brother before you bring your offering — and Romans 5:10."},
    {k:"rule"},
    {k:"h3", t:"Some Basic Steps to Reconciliation"},
    {k:"num", items:["**Admit** the wrong — acknowledge what was done.", "**Be sorry** — show genuine regret and repentance.", "**Ask for forgiveness** — from God and from the offended person.", "**Make amends** — put right the harm done where possible.", "**Restore** — rebuild trust and live in peace.", "**Forgive** — release the offence and do not hold a grudge."]},
    {k:"p", t:"These steps are taught in Christianity, Islam and African Traditional Religion — reconciliation from **multi-religious backgrounds**."},
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:["Discuss the basis of reconciliation relating to confusion in the class, in terms of gender roles and tribes.", "Give personal definitions of the concept of reconciliation.", "Divide into groups and dramatize the process of reconciliation.", "Write four or five paragraphs in your own words about reconciliation as it relates to man to God, man to man and man to self."]}
  ],
...
},
{
  ...
  study:[
    /* ---- course text: Semester One, Period II — Religion and Substance Abuse (pages 4-5) ---- */
    {k:"h3", t:"Definition of Terms"},
    {k:"p", t:"**Religion** is the belief in and worship of God, with the teachings and practices that flow from that belief. **Substance abuse** is the harmful use of drugs and other substances — taking them in ways or amounts that damage the body, the mind, the family and society. Learners know the danger of substance abuse in the family, in the church and mosque, and in society, and increase all efforts to stay drug free while counseling others through religious teachings."},
    {k:"rule"},
    {k:"h3", t:"Commonly Abused Substances in Liberia"},
    {k:"bul", items:["**Alcohol** — beer, cane juice and other strong drinks", "**Tobacco** — cigarettes and other smoked tobacco", "**Marijuana (weed)** — an illegal drug smoked for its effects", "**Cocaine, heroin and other hard drugs** — dangerous drugs that destroy the body", "**Abuse of medicines** — taking drugs without prescription or in wrong doses"]},
    {k:"p", t:"Learners list the commonly abused substances in their community and their **impact on the human body**."},
    {k:"rule"},
    {k:"h3", t:"Causes of Substance Abuse"},
    {k:"bul", items:["Poverty and unemployment", "Peer pressure — friends who use drugs", "Family problems and broken homes", "Curiosity and the desire to experiment", "Lack of religious and moral training", "Stress, worry and discouragement"]},
    {k:"rule"},
    {k:"h3", t:"Health Effects of Substance Abuse"},
    {k:"p", t:"Substance abuse **destroys health**: it damages the brain, the liver, the heart and the lungs; it causes addiction, madness and death; it breaks families, causes crime and slows the growth and development of the nation. Scripture references: the Holy Bible, Proverbs 21:17, Proverbs 23:31 (do not gaze at wine), Proverbs 5:18 and Titus 1:7 — leaders must not be given to much wine; the Holy Qur'an teaches that intoxicants are harmful."},
    {k:"rule"},
    {k:"h3", t:"Prevention of Substance Abuse"},
    {k:"bul", items:["**Religious teaching** — the body is the temple of God; keep it pure (1 Corinthians 6:19-20)", "**Saying no** — refuse drugs firmly, even when friends press you", "**Good company** — choose friends who respect you and God", "**Useful activities** — sports, music, study and service", "**Counseling** — talk to parents, teachers, pastors and imams", "**Stay drug free** — and counsel others to do the same"]},
    {k:"p", t:"In group discussion, learners tell how substance abuse can be avoided through religious teachings."},
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:["Research and write three paragraphs on substance abuse and how it impacts the negative growth and development of the nation.", "List the commonly abused substances in your community and their impact on the human body.", "Write five paragraphs on the causes, effects and prevention of substance abuse.", "Write a short story on your personal observation of substance abuse, its negative impact and how it can be prevented."]}
  ],
...
},
{
  ...
  study:[
    /* ---- course text: Semester One, Period III — The Individual and Society (page 6) ---- */
    {k:"h3", t:"Man's Duties to God as Creator"},
    {k:"p", t:"Every individual has **duties to God the Creator**: to worship Him, obey His commandments, thank Him and serve Him. Scripture references: the Holy Bible, Ecclesiastes 12:13 — *'Fear God and keep His commandments, for this is the whole duty of man'* — and 1 Thessalonians 5:15."},
    {k:"rule"},
    {k:"h3", t:"Man's Responsibilities to Self, Family and Society"},
    {k:"p", t:"The individual also has **responsibilities to self, family and society**: to take care of his or her own health and character, to support and protect the family, and to be a good citizen of the nation."},
    {k:"bul", items:["**To self** — keep a pure heart, a healthy body and a good name", "**To the family** — love, respect, obey and help at home", "**To the church and mosque** — worship, serve and give", "**To society and the nation** — obey the law, pay dues, and work for the common good"]},
    {k:"p", t:"Scripture references: the Holy Bible, Romans 13:7 — give to everyone what you owe them — and Matthew 22:21 — *'Give back to Caesar what is Caesar's, and to God what is God's'*."},
    {k:"rule"},
    {k:"h3", t:"What the Holy Books Teach about Duties"},
    {k:"p", t:"Learners state **what the Holy Books teach about the individual's duties to his or her family and to mankind in general**: honour your father and mother, love your neighbour as yourself, care for the orphan and the poor, and do to others what you would have them do to you. The Holy Qur'an likewise teaches kindness to parents, relatives and neighbours."},
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:["Tell your experiences in attending worship service in the church or mosque as your duty and obligation to God the Creator.", "Carry out your obligations to nation building by being a good citizen.", "Explain in class discussion examples of religious personalities as role models.", "Visit a church or mosque and report on your visit."]}
  ],
...
},
{
  ...
  study:[
    /* ---- course text: Semester Two, Period IV — Worship and Offering (pages 7-8) ---- */
    {k:"h3", t:"The Meaning of Worship"},
    {k:"p", t:"**Worship** is the honour and reverence we give to God — through praise, prayer, the reading of the Holy Books and the giving of offerings. **Offering** is the gift we bring to God in service. Learners understand and practise different kinds of worship through giving, praying and reading the Holy Books, and they know why some church structures differ in building plan from others — and that all structures should facilitate the physically disabled."},
    {k:"rule"},
    {k:"h3", t:"Why Do We Give Offering in Service?"},
    {k:"p", t:"We give offerings in service to **honour God**, to **support the house of God**, to **help the poor and needy**, and to **show that our hearts are grateful**. Scripture references: the Holy Bible, Ephesians 5:2 — walk in love as Christ loved us and gave Himself for us — and Hebrews 13:15 — the sacrifice of praise."},
    {k:"rule"},
    {k:"h3", t:"The Use of Holy Books in the Church and in the Mosque"},
    {k:"p", t:"The **Holy Books are used in worship** for reading, teaching, prayer and preaching. Scripture references: the Holy Bible, Exodus 24:7 (Moses read the Book of the Covenant aloud to the people), Acts 15:21, 1 Thessalonians 5:27, Colossians 4:16 and Ephesians 5:2. The Holy Qur'an is recited, read and studied in the mosque and at home."},
    {k:"rule"},
    {k:"h3", t:"Types and Purpose of Various Prayers"},
    {k:"bul", items:["**Private prayer** — praying alone to God", "**Family prayer** — praying together at home", "**Public prayer** — praying in the congregation at church or mosque", "**Intercessory prayer** — praying for others", "**Thanksgiving prayer** — thanking God for His goodness", "**The five daily prayers of the mosque** — the salat of the Muslim faith"]},
    {k:"rule"},
    {k:"h3", t:"Structures, Symbols and Gestures Used in Worship"},
    {k:"p", t:"Worship uses visible **structures, symbols and gestures** that differ between denominations and faiths:"},
    {k:"bul", items:["**The church** — the cross, the altar, the pulpit, hymns, kneeling and standing in prayer", "**The mosque** — the dome with the stars and moon on top, the minaret, the call to prayer, and bowing and prostrating in prayer", "**The meaning of the structures** — know what the different styles in structures mean to different denominations"]},
    {k:"p", t:"Learners list the different forms of worship, the gestures, the purpose of giving offering, and the use of Holy Books during worship service in the church and mosque, and make a visitation to a church or mosque with an interview with the leadership."},
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:["List the different forms of worship, the gestures, the purpose of giving offering, and the use of Holy Books during worship service in the church or mosque.", "Make a visitation to the church or mosque and interview the leadership.", "Give a group presentation on styles in structure designs of church or mosque."]}
  ],
...
},
{
  ...
  study:[
    ...
    {k:"p", t:"Learners care for others to **avoid marginalizing those suffering** from STIs: treat them with love and respect, encourage them to seek treatment, and never mock or reject them. Stigmatization drives people away from help."},
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:["Research STIs, their transmission, mode and prevention.", "In class discussion, talk about the impact of STIs on the individual, family and community at large.", "Hold a group discussion on the results from research on STIs.", "Write an essay on how STIs are prevented, transmitted, treated or managed, and how stigmatization is avoided."]}
  ],
...
},
{
  ...
  study:[
    /* ---- course text: Semester Two, Period VI — Peace (page 11) ---- */
    {k:"h3", t:"The Meaning of Peace"},
    {k:"p", t:"**Peace** is a state of calm, safety and harmony — between a person and God, within a person, between people, and in the nation. Learners appreciate the importance of peace and define peace from a **multi-religious standpoint**: the Bible calls God the *God of peace* (John 14:27); the Qur'an teaches that peace (salam) is a central goal of Islam, and the greeting of Muslims is *'peace be upon you'*."},
    {k:"p", t:"Scripture references: the Holy Bible, Ezekiel 13:10, Mark 9:50, John 14:27 — *'Peace I leave with you; My peace I give you'* — John 16:33, 1 Corinthians 7:15 and 1 Thessalonians 5:13."},
    {k:"rule"},
    {k:"h3", t:"Obstacles to Peace"},
    {k:"bul", items:["Selfishness, greed and jealousy", "Lies, gossip and bad words", "Unforgiveness and holding grudges", "Tribalism, favouritism and discrimination", "Disobedience and disrespect", "Conflict and violence in the family, school and community"]},
    {k:"p", t:"Learners identify and **eliminate challenges to peace**: they state means of removing obstacles to peace, such as forgiveness, truthfulness, justice, respect and reconciliation."},
    {k:"rule"},
    {k:"h3", t:"Sustaining Lasting Peace"},
    {k:"p", t:"Learners initiate steps to **sustaining lasting peace through religious and community-based initiatives**:"},
    {k:"bul", items:["**Pray for peace** — in the family, the church, the mosque and the nation", "**Live peacefully** — be calm, kind and slow to anger", "**Preach and practise peace** — religious teachings of love, mercy and forgiveness", "**Resolve conflicts quickly** — before they grow", "**Build community** — work together with people of every tribe and religion", "**Educate others** — teach the young the value of peace"]},
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:["Research and make a class presentation on the purpose of peace, eliminating obstacles to peace, and sustaining peace.", "Write a written report on peace from a religious perspective.", "Write five paragraphs on how to obtain peace in your family, school and community, and on removing obstacles to peace building."]}
  ],
...
/* ================================ GRADE 8 ================================ */
{
  ...
  study:[
    /* ---- course text: Semester One, Period I — Substance Abuse (page 12) ---- */
    {k:"h3", t:"How Religion Helps Eliminate Substance Abuse"},
    {k:"p", t:"Learners understand through **religious teachings** the harmful effects of substance abuse on the body, and disseminate to their peers information on how to prevent it through religious practices. Religion helps eliminate substance abuse by teaching that the **body is the temple of God**, by commanding self-control, and by giving people a community of faith that supports good living."},
    {k:"rule"},
    {k:"h3", t:"Commonly Abused Substances in Liberia"},
    {k:"bul", items:["**Alcohol** — cane juice, beer and spirits", "**Tobacco** — cigarettes and snuff", "**Marijuana (weed, kush)** — illegal drugs", "**Cocaine and heroin** — dangerous hard drugs", "**Misused medicines** — tablets and syrups taken without prescription"]},
    {k:"p", t:"List some commonly abused substances in Liberia and their **negative impact on the body**: damage to the brain, liver, heart and lungs; addiction; madness; poverty; crime; and early death."},
    {k:"rule"},
    {k:"h3", t:"Religious and Moral Teachings on Prevention"},
    {k:"p", t:"Learners give **religious and moral teachings on the causes, effects and prevention of substance abuse**:"},
    {k:"bul", items:["**The Holy Bible** — Proverbs 21:17 (whoever loves pleasure will become poor), Proverbs 23:31 (do not gaze at wine), Proverbs 5:18 and Titus 1:7 — leaders must not be addicted to wine; the body is the temple of the Holy Spirit (1 Corinthians 6:19-20)", "**The Holy Qur'an** — believers must avoid intoxicants; what harms the body and mind is forbidden", "**Moral teaching** — self-control, respect for self, and the duty to protect the family and the nation"]},
    {k:"p", t:"Learners meet in small groups to name and discuss the causes and prevention of substance abuse through religious teachings, and elevate the negative impact of substance abuse in the community through the **distribution of informative religious flyers and leaflets** and month-to-month conversation."},
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:["State how religion helps eliminate substance abuse.", "List some commonly abused substances in Liberia and their negative impact on the body.", "Give some religious and moral teachings on the causes, effects and prevention of substance abuse."]}
  ],
...
},
{
  ...
  study:[
    /* ---- course text: Semester One, Period II — Conflict and its Resolution (page 13) ---- */
    {k:"h3", t:"Defining Conflict"},
    {k:"p", t:"**Conflict** is a disagreement, quarrel or struggle between people or groups. Learners are able to identify conflict and to resolve and manage it through **conflict resolution**."},
    {k:"rule"},
    {k:"h3", t:"Classifying Conflict"},
    {k:"bul", items:["**Spiritual conflict** — the struggle between good and evil, right and wrong", "**Physical conflict** — fighting, quarrelling and violence with the body", "**Family conflict** — quarrels within the home", "**Ethnic conflict** — conflict between ethnic groups", "**Community and national conflict** — disputes over land, power and resources"]},
    {k:"rule"},
    {k:"h3", t:"Sources of Conflict"},
    {k:"bul", items:["Misunderstanding and bad communication", "Greed, selfishness and jealousy", "Injustice and unfairness", "Tribalism and discrimination", "Pride and refusal to forgive", "Bad leadership and misuse of power"]},
    {k:"rule"},
    {k:"h3", t:"Methods of Conflict Resolution"},
    {k:"p", t:"Learners list and apply **methods of conflict resolution**:"},
    {k:"bul", items:["**Dialogue** — talk the matter through calmly", "**Mediation** — a neutral third person helps the parties agree", "**Arbitration** — an elder or leader hears both sides and gives a decision", "**Negotiation** — each side gives and takes until a settlement is reached", "**Reconciliation** — forgive and restore the relationship", "**Legal settlement** — the courts of the land decide where needed"]},
    {k:"p", t:"Scripture references: the Holy Bible, John 14:27 and John 16:33 (My peace I give you), Philippians 4:7 (the peace of God guards the heart), Romans 5:1 and Romans 14:17 — the kingdom of God is righteousness, peace and joy. The Holy Qur'an also teaches forgiveness and reconciliation."},
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:["Define the various types of conflict and list methods of conflict resolution.", "Divide into three groups: two groups to dramatize conflict and another group to manage conflict methods and resolution."]}
  ],
...
},
{
  ...
  study:[
    /* ---- course text: Semester Two, Period IV — Reconciliation (page 15) ---- */
    {k:"h3", t:"Defining Reconciliation"},
    {k:"p", t:"**Reconciliation** is the restoring of a broken relationship — bringing two parties that were separated back into peace and harmony. Learners know and understand **who the Chief Reconciler is** and will live in harmony with God and with their fellow man."},
    {k:"rule"},
    {k:"h3", t:"Who Is the Chief Reconciler?"},
    {k:"p", t:"In Christian teaching, **Jesus Christ is the Chief Reconciler** — the one through whom God reconciles the world to Himself: *'God was reconciling the world to Himself in Christ'* (2 Corinthians 5:18-19). Scripture references: the Holy Bible, Hebrews 2:17 (He became a merciful and faithful high priest to make atonement) and Romans 5:10."},
    {k:"rule"},
    {k:"h3", t:"How Man Is Reconciled to God"},
    {k:"p", t:"Man is **reconciled to God** through repentance and faith: he admits his sin, turns from it, and receives God's forgiveness through the work of the Reconciler. The Qur'an likewise teaches that God is Oft-Forgiving and that sincere repentance (tawbah) restores the believer to God's mercy."},
    {k:"rule"},
    {k:"h3", t:"How Man Is Reconciled to His Fellow Man"},
    {k:"p", t:"Man is **reconciled to his fellow man** by admitting wrong, apologising, asking forgiveness, making amends and forgiving. Scripture reference: the Holy Bible, Matthew 5:24 — first be reconciled to your brother, then bring your offering."},
    {k:"rule"},
    {k:"h3", t:"Fundamental Steps to Reconciliation"},
    {k:"num", items:["**Recognise** the brokenness — admit that the relationship is damaged.", "**Repent** — be truly sorry for your part in the wrong.", "**Confess** — admit the wrong openly to God and to the person.", "**Forgive** — release the offence, as God forgives you.", "**Restore** — rebuild trust through changed behaviour.", "**Live in peace** — walk in harmony with God and man."]},
    {k:"p", t:"Learners outline some basic **religious and moral teachings on reconciliation** from the Bible, the Qur'an and traditional teachings, and identify the reconciler in a class conflict through role-play."},
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:["Write a two-page essay on the definition and process of reconciliation.", "In class discussion, indicate how man is reconciled to God and reconciled to each other.", "Identify the Chief Reconciler and the works that He did to reconcile man to God.", "In a role-play, identify the reconciler in a class conflict."]}
  ],
...
},
{
  ...
  study:[
    /* ---- course text: Semester Two, Period V — Stewardship (page 16) ---- */
    {k:"h3", t:"What Is Stewardship?"},
    {k:"p", t:"**Stewardship** is the responsible care and management of what God has entrusted to us. Learners understand the meaning of stewardship and know the personal responsibilities of being good stewards **at home, at school, at the place of worship, in the community and in the nation**, as assigned by God."},
    {k:"p", t:"Scripture references: the Holy Bible, Genesis 1:26-28 (God gave man dominion over the earth), Genesis 2:15 (man was put in the garden to work it and keep it), Genesis 2:19-20 (man named the animals), Luke 12:24, Titus 1:7 and 1 Peter 4:10 — *'Each of you should use whatever gift you have received to serve others, as faithful stewards of God's grace'*."},
    {k:"rule"},
    {k:"h3", t:"Man as Steward of His Family"},
    {k:"p", t:"Man is steward of his **family**: to provide for them, protect them, train them in the fear of God and love them. Stewardship of the family means the family is cared for as a trust from God."},
    {k:"rule"},
    {k:"h3", t:"Man as Steward of His Time"},
    {k:"p", t:"Man is steward of his **time**: time is a gift from God, and every hour should be used wisely — for work, study, rest, worship and service. Wasted time cannot be recovered."},
    {k:"rule"},
    {k:"h3", t:"Man as Steward of His Talents and Expertise"},
    {k:"p", t:"Man is steward of his **talents and expertise**: the skills and abilities God gave us are to be developed and used for the good of others and the glory of God — the parable of the talents (Matthew 25:14-30) teaches that faithful stewards use and increase what the master gave them."},
    {k:"rule"},
    {k:"h3", t:"Man as Steward of the Physical Environment"},
    {k:"p", t:"Man is steward of the **physical environment**: the land, water, air, plants and animals. God placed man in the garden *'to work it and keep it'* (Genesis 2:15) — so we must protect the environment: plant trees, keep our surroundings clean, avoid pollution and use resources wisely."},
    {k:"p", t:"The Holy Qur'an and the Holy Book of Creation likewise teach that man is the vicegerent (khalifah) of God on earth, responsible for the care of creation."},
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:["Research the religious and moral stewardship of man to God the Creator, to man, to his family, to his time, to his talents and expertise, and to his physical environment.", "Do a written home assignment for class discussion defining stewardship and the purpose of stewardship."]}
  ],
...
},
{
  ...
  study:[
    /* ---- course text: Semester Two, Period VI — Religious Practices and their Moral Implications (page 17) ---- */
    {k:"h3", t:"Moral Implications of Religious Practices"},
    {k:"p", t:"Learners know the **moral teachings of Christianity, Islam and Oral Traditions on society** and are able to live up to the principles learnt. They observe some **religious practices** and explain their **moral implications** — how the practices of a religion shape the behaviour and character of its people."},
    {k:"rule"},
    {k:"h3", t:"Defining Sacred Scriptures and Oral Tradition"},
    {k:"bul", items:["**Sacred scriptures** — the holy writings of a religion believed to be the word of God: the Holy Bible for Christians, the Holy Qur'an for Muslims", "**Oral tradition** — the teachings, myths, beliefs and stories passed down by word of mouth from one generation to the next"]},
    {k:"rule"},
    {k:"h3", t:"Moral Teachings of the Christian Scriptures"},
    {k:"p", t:"Learners name some **moral teachings of the Christian scriptures (the Holy Bible)**: love God and love your neighbour, honour your father and mother, do not steal, do not lie, forgive one another, care for the poor and the widow, and be holy because God is holy. Scripture references: the Holy Bible, Exodus 3:3-6 and 1 Timothy 2:11-12."},
    {k:"rule"},
    {k:"h3", t:"Moral Teachings of the Islamic Scriptures"},
    {k:"p", t:"Learners name some **moral teachings of the Islamic scriptures (the Holy Qur'an)** and the Book of Moses: worship one God, pray, give charity (zakat), fast, be truthful, keep promises, honour parents, be just and merciful, and avoid what is forbidden."},
    {k:"rule"},
    {k:"h3", t:"Moral Teachings of Oral Traditions — Myths, Beliefs and Teachings"},
    {k:"p", t:"Learners name some **moral teachings of the oral traditions**: the myths, beliefs and teachings of the elders — respect for elders, hospitality to strangers, honesty, hard work, community solidarity and reverence for the sacred. Learners research and give a class presentation on the **differences of the Christian faith, the Islamic faith, and the traditions and oral beliefs**."},
    {k:"rule"},
    {k:"h3", t:"Debate — Similarities and Differences in the Three Faiths"},
    {k:"p", t:"Learners debate the similarity or difference in the three faiths on practices such as:"},
    {k:"bul", items:["**Covering of heads by women** before entering the church", "**Women not allowed to pastor a church**", "**Women not to teach men**", "How each faith respects the sacred and orders the roles of its members"]},
    {k:"p", t:"Supplementary texts: Oral Traditions and Myths; posters and other instructional aids."},
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:["Name some moral teachings of the Holy Bible (the Christian faith), the Holy Qur'an (the Islamic faith) and the oral tradition (myths, beliefs and teachings).", "Research and give a class presentation on the differences between the Christian faith, the Islamic faith, and the traditions and oral beliefs.", "Debate the similarities and differences in the three faiths on the practices listed."]}
  ],
...
/* ================================ GRADE 9 ================================ */
{
  ...
  study:[
    /* ---- course text: Semester One, Period I — Religious Personalities and their Moral Teachings of the Religious Leaders (pages 18-19) ---- */
    {k:"h3", t:"Defining Religion and Its Impact"},
    {k:"p", t:"**Religion** is the belief in and worship of God, with the teachings and practices that flow from it. Religion has an **impact on mankind** — positively, when it teaches love, justice and mercy, and negatively, when it is misused for selfishness, division or violence. Learners are capable of explaining the moral and spiritual teachings of **Jesus Christ**, **Prophet Mohammed** and the **African Traditional Religious Leaders**."},
    {k:"rule"},
    {k:"h3", t:"The Patriarchs, the Caliphs of Islam and the Traditional Religious Leaders"},
    {k:"p", t:"Learners convincingly explain some of the **teachings of the Patriarchs** (the fathers of the faith, such as Abraham, Isaac, Jacob and Moses), the **Caliphs of Islam** (the early successors of Prophet Mohammed who led the Muslim community) and the **Traditional Religious Leaders** (the priests, elders and custodians of the African traditional religion), and their **contributions to religion**."},
    {k:"rule"},
    {k:"h3", t:"Jesus Christ — His Parables and the Sermon on the Mount"},
    {k:"p", t:"Learners explain the teachings of Jesus Christ:"},
    {k:"bul", items:["**The Parable of the Sower** (Matthew 13:3-8, 18-23) — the word of God falls on different kinds of ground: the path, the rocky soil, the thorns and the good soil", "**The Parable of the Prodigal Son** (Luke 15:11-32) — the forgiving love of the father", "**The Parables of the Kingdom** — the kingdom of heaven is like a mustard seed, a treasure, a pearl", "**The Sermon on the Mount** (Matthew 5:3-16) — the Beatitudes: blessed are the poor in spirit, the meek, the merciful, the pure in heart and the peacemakers"]},
    {k:"rule"},
    {k:"h3", t:"Prophet Mohammed — His Moral Teachings"},
    {k:"p", t:"Learners study the **moral teachings of Prophet Mohammed**: the worship of one God (Allah), prayer, charity, honesty, justice, mercy, care for orphans and the poor, and good treatment of neighbours. The **Sunna** — the example and sayings of the Prophet — guides Muslims in daily life."},
    {k:"rule"},
    {k:"h3", t:"African Traditional Religious Leaders — Their Moral Teachings"},
    {k:"p", t:"Learners compare and contrast the moral teachings of Jesus Christ, Prophet Mohammed and the **African Traditional Religious Leaders**: the traditional leaders teach respect for the ancestors, reverence for the Supreme Being, honesty, hospitality, respect for elders, and the sacredness of life and community."},
    {k:"p", t:"Learners compare and contrast the moral teachings of **Jesus Christ and the Prophet Mohammad**, and the moral teachings of the **Patriarchs and African Traditional Religious Leaders**. Primary texts: the Holy Bible (Matthew 13:3-8, 18-23; Luke 15:11-32; Matthew 5:3-16), the Holy Qur'an and the Holy Book of Moses."},
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:["Research and write a three-page essay on the Patriarchs, the Caliphs of Islam and the Traditional Religious Leaders.", "Compare and contrast the moral teachings of Jesus Christ, Prophet Mohammed and the African Traditional Religious Leaders.", "Work in groups to develop a drama on the life of the Prodigal Son, the Sunna, or drumming."]}
  ],
...
},
{
  ...
  study:[
    /* ---- course text: Semester One, Period II — Commitment to God (page 20) ---- */
    {k:"h3", t:"Defining Commitment"},
    {k:"p", t:"**Commitment** is a firm promise or pledge — giving yourself completely to a person or a cause. Learners understand **God's commitments to man and man's commitment to God**, and live in accordance with the premise of the religious teachings given by the messengers of God."},
    {k:"rule"},
    {k:"h3", t:"God's Commitments to Mankind"},
    {k:"p", t:"God has made **commitments (covenants) to mankind** and He keeps them:"},
    {k:"bul", items:["**To Noah** — God promised never again to destroy the earth with a flood (Genesis 8:20-22; Genesis 9:2-17)", "**To Abraham** — God promised to make of him a great nation and to bless all peoples through him", "**To His people** — God promises to care for, guide and save those who trust Him (Psalm 104; Matthew 6:26-30; Matthew 10:29)", "**The promises of God** — for the earth and for heaven (2 Chronicles 7:14)"]},
    {k:"rule"},
    {k:"h3", t:"Man's Commitments to God"},
    {k:"p", t:"Man responds with his own **commitments to God**: to love Him, obey His commandments, worship Him, serve Him and remain faithful to Him. Learners explain the Christian, Muslim and Traditionalist **responses to God's promises**."},
    {k:"rule"},
    {k:"h3", t:"God's Messengers to Mankind"},
    {k:"p", t:"God sent **messengers** to mankind in every age to call people back to Him: the prophets of the Bible (Noah, Abraham, Moses, the prophets of Israel), the prophets of the Qur'an (ending with Prophet Mohammed, whose teaching is followed by Muslims), and the messengers and teachers honoured in African traditional religion."},
    {k:"rule"},
    {k:"h3", t:"Man's Commitment to God through Religious Teachings"},
    {k:"bul", items:["**Christian teachings** — commitment through faith in Jesus Christ, baptism, prayer and obedience", "**Islamic teachings** — commitment through the declaration of faith (shahada), the five daily prayers, fasting, charity and pilgrimage", "**Traditional teachings** — commitment through honouring the ancestors, reverence for the Supreme Being and the customs of the community"]},
    {k:"p", t:"Learners give at least **five of God's promises for the earth and for heaven**, and dramatize man's commitments to God in worship."},
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:["Research and discuss God's commitments to man through the teachings of Christianity, Islam and tradition.", "Dramatize man's commitments to God in worship.", "Give at least five of God's promises for the earth and for heaven."]}
  ],
...
},
{
  ...
  study:[
    /* ---- course text: Semester One, Period III — Various Religious Festivals and their Values (page 21) ---- */
    {k:"h3", t:"Religious Festivals"},
    {k:"p", t:"**Religious festivals** are special days when believers celebrate the great events and teachings of their faith. Learners are able to analyze the **importance of religious festivals**, classify them in line with their **moral values**, and participate according to their faith."},
    {k:"rule"},
    {k:"h3", t:"Christian Festivals"},
    {k:"bul", items:["**Christmas** — the celebration of the birth of Jesus Christ (Matthew 1:18-21; Matthew 2)", "**Easter** — the celebration of the death and resurrection of Jesus Christ (Matthew 26:17-30; Matthew 27:1-66; Mark 16:1-20; Luke 24:1-49)", "**Fast and Prayer Day** — a day set apart for fasting and prayer for the nation", "**Thanksgiving Day** — a day of giving thanks to God for His goodness"]},
    {k:"rule"},
    {k:"h3", t:"Muslim Festivals"},
    {k:"bul", items:["**Eid al-Fitr** — the festival that marks the end of the fasting month of Ramadan, with prayers, feasting and charity", "**Eid al-Adha** — the festival of sacrifice, remembering the obedience of Prophet Ibrahim; Muslims pray, sacrifice and share with the poor", "**The festival of the new year and other holy days** — days of prayer and remembrance in the Muslim community"]},
    {k:"rule"},
    {k:"h3", t:"Traditional Festivals of Some Ethnic Groups of Liberia"},
    {k:"p", t:"Learners name some **traditional festivals of the ethnic groups of Liberia**: the harvest festivals, the festivals of the new year, the coming-of-age ceremonies and the festivals honouring the ancestors and the spirits — celebrated with music, drumming, dancing and feasting."},
    {k:"rule"},
    {k:"h3", t:"The Importance and Value of Religious Festivals"},
    {k:"p", t:"Learners state the **value of each religious festival for moral development**:"},
    {k:"bul", items:["They **remember** the great works of God and the heroes of faith", "They **teach** the young the history and beliefs of the faith", "They **build community** — families and neighbours come together", "They **encourage charity** — the poor are fed and remembered", "They **renew commitment** — believers rededicate themselves to God", "They **strengthen moral values** — love, sharing, thankfulness and obedience"]},
    {k:"p", t:"Learners differentiate between the various religious festivals through research, and interview religious leaders to understand the purpose and meaning of the festivals."},
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:["Name some religious festivals.", "Explain some of the religious festivals.", "State the value of each religious festival for moral development.", "Interview religious leaders to understand the purpose and meaning of various religious festivals."]}
  ],
...
},
{
  ...
  study:[
    /* ---- course text: Semester Two, Period IV — Religion and Health (page 22) ---- */
    {k:"h3", t:"The Positive Impact of Religion on Health"},
    {k:"p", t:"Learners are able to analyze how **religions positively impact healthy living** and teach others in the community to practise religious teachings in their daily lives. Religion promotes health by teaching **purity, moderation, rest, prayer, hope and care for the body**."},
    {k:"bul", items:["**Christianity** — the body is the temple of the Holy Spirit (1 Corinthians 6:19-20); believers are taught to keep pure and to care for the sick (1 Peter 3:1)", "**Islam** — cleanliness, fasting, prayer, and the prohibition of intoxicants keep body and mind healthy; the Qur'an teaches that what is lawful is good", "**African Traditional Religion** — the sacredness of life, the care of the community and the healing practices of the traditional healers"]},
    {k:"p", t:"Scripture references: the Holy Bible, Exodus 20:1-7, 1 Peter 3:1 and Colossians 3:18-19 — the commandments and the order of the home promote peace and health."},
    {k:"rule"},
    ...
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:["List ways of how religions offer safety in community health.", "Research how compliance with religious rules helps in the prevention of health problems in society.", "List five possibilities of how religions offer safety in community health."]}
  ],
...
},
{
  ...
  study:[
    /* ---- course text: Semester Two, Period V — The Ministries of Religious Leaders and Traditional Priests (pages 23-24) ---- */
    {k:"h3", t:"The Ministries of Jesus Christ"},
    {k:"p", t:"Learners name some of the **ministries of Jesus Christ** and apply His teachings to their daily lives:"},
    {k:"bul", items:["**The calling of His disciples** — He chose twelve men to follow Him and learn from Him (Luke 6:12-15; Luke 5:1-11)", "**The commissioning of His disciples** — He sent them out to preach, heal and serve", "**His healing of the sick** — He healed the blind, the deaf, the lame and the diseased (Mark 8:22-26; Mark 5:42-47)", "**His moral teachings** — the Sermon on the Mount, the parables, the commandment of love", "**His death and resurrection** — He died for sin and rose again on the third day (Matthew 28:1-13; Matthew 24:32-35)"]},
    {k:"rule"},
    {k:"h3", t:"The Ministries of Prophet Mohammed"},
    {k:"p", t:"Learners narrate stories about the **ministries of Prophet Mohammed**:"},
    {k:"bul", items:["**His Hijrah to Medina** — the Prophet's journey from Mecca to Medina, which marks the beginning of the Islamic year", "**His last pilgrimage** — the farewell pilgrimage in which he taught the Muslims their duties", "**His triumphant entry into Mecca** — he entered Mecca peacefully and forgave his enemies", "**His moral teachings** — the worship of one God, justice, mercy, charity and the brotherhood of believers"]},
    {k:"rule"},
    {k:"h3", t:"The Ministries of Traditional Priests"},
    {k:"p", t:"Learners name the **ministries of traditional priests** in African traditional religion:"},
    {k:"bul", items:["**Healing of the sick** — using herbs and spiritual rites", "**Pouring libation** — pouring drink as an offering to the ancestors and the spirits", "**Offering sacrifices** — offering sacrifices to the gods for the sick and for other purposes", "**Acting as counselors** — advising and comforting hurting people"]},
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:["Research and write a one-page essay on the ministries of Jesus Christ: the calling and commissioning of His disciples, His healing of the sick, His moral teachings, and His death and resurrection.", "Research and write on the ministries of Prophet Mohammed: His Hijrah to Medina, His last pilgrimage and His triumphant entry into Mecca.", "Dramatize a story each of Jesus Christ, Prophet Mohammed and the Traditional Priest.", "Write four paragraphs on two stories of Jesus Christ, Prophet Mohammed or the Traditional Priests, and indicate the moral benefits to our society today."]}
  ],
...
},
{
  ...
  study:[
    /* ---- course text: Semester Two, Period VI — Chastity and Immorality (page 25) ---- */
    {k:"h3", t:"Chastity and Immorality"},
    {k:"p", t:"**Chastity** is the virtue of sexual purity — keeping oneself pure until marriage and being faithful within marriage. **Immorality** is living against the moral law of God, including sexual sin. Learners demonstrate a lifestyle that benefits themselves as individuals, the family and the nation as a whole by living the **high moral standards derived from religious moral teachings**."},
    {k:"rule"},
    {k:"h3", t:"The Importance of Chastity in Islam"},
    {k:"p", t:"In Islam, **chastity is a duty of every believer**: Muslims are commanded to guard their chastity, lower their gaze, dress modestly and avoid all unlawful sexual relations; marriage is encouraged as the pure way of life, and the Qur'an forbids fornication and adultery."},
    {k:"rule"},
    {k:"h3", t:"The Importance of Chastity in Christianity"},
    {k:"p", t:"In Christianity, **chastity is commanded**: the body is the temple of the Holy Spirit, and believers are called to flee sexual immorality and to honour marriage (1 Corinthians 6:18-20; Hebrews 13:4). Chastity keeps the believer pure before God and preserves the family."},
    {k:"rule"},
    {k:"h3", t:"Chastity and Immorality in African Traditional Religion"},
    ...
    {k:"rule"},
    {k:"h3", t:"Assignment"},
    {k:"num", items:["Differentiate between chastity and immorality.", "Compare and contrast Islamic and Christian teachings on chastity.", "Explain why and how a person should live a chaste life by the teaching of African Traditional Religion.", "State the importance of living a chaste life and the dangers of an immoral lifestyle."]}
  ],
