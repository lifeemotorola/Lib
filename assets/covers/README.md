...
These 15 PNG files are the built-in, subject-matched cover backgrounds. `build.sh`
...
The single `wa.png` cover used by **every** subject in the WASSCE session is an
**AI-generated image** (modelled on the real WAEC objective-test answer sheet),
not a photograph — see the second table below.
...
or licence to clear. It is modelled on the authentic WAEC WASSCE objective-test
