...
/* ================================ GRADE 8 ================================ */
{
  ...
  study:[
    /* ---- verbatim-style course text: Semester One, Period I ---- */
    {k:"h3", t:"Liberia on the Map of West Africa"},
    {k:"p", t:"Liberia is on the **west coast of Africa**, just north of the equator, facing the **Atlantic Ocean**."},
    {k:"p", t:"Liberia's boundaries are:"},
    {k:"bul", items:["**Sierra Leone** – to the northwest.","**Guinea** – to the north and northeast.","**Côte d'Ivoire** – to the east.","**The Atlantic Ocean** – to the south and southwest."]},
    {k:"rule"},
    {k:"h3", t:"Physical Features of Liberia"},
    {k:"p", t:"The land of Liberia rises in four belts from the sea: the **coastal plain**, the **rolling hills**, the **plateau**, and the **mountains**."},
    {k:"p", t:"Many rivers flow from the interior to the Atlantic Ocean. The major rivers are the **Mano, Morro, Lofa, St. Paul, St. John, Cestos, and Cavalla**."},
    {k:"rule"},
    {k:"h3", t:"Major Natural Resources of Liberia"},
    {k:"p", t:"Liberia is rich in natural resources. The major ones are:"},
    {k:"bul", items:["**Iron ore** – mined at Nimba, Bomi and Grand Cape Mount.","**Gold and diamonds** – found in Lofa, Grand Cape Mount and the southeast.","**Timber** – the forests give hard and valuable woods.","**Rubber, cocoa and coffee** – plantation crops.","**Water** – rivers give hydro-electric power and fish."]},
    {k:"rule"},
    {k:"h3", t:"Political Sub-divisions of Liberia"},
    {k:"p", t:"Liberia is divided into **fifteen counties**, which are further divided into districts, clans and towns. The capital city is **Monrovia**, in Montserrado County."},
    {k:"p", t:"The counties make government, development and the counting of people easier, and they spread services across the whole country."},
    {k:"rule"},
    {k:"h3", t:"Manufacturing and Mining Industries"},
    {k:"p", t:"**Mining industries** take minerals from the ground, such as **iron ore, gold and diamonds**."},
    {k:"p", t:"**Manufacturing industries** turn raw materials into finished goods, such as **rubber processing, cement, furniture, soap, and food and drinks**."},
    {k:"p", t:"These industries give **jobs**, earn **foreign money**, and build **roads, schools and hospitals** for the country."}
...
},
{
  ...
  study:[
    ...
    {k:"p", t:"**Weather** is the condition of the atmosphere at one place over a **short time** (a day or a week)."},
    {k:"p", t:"**Climate** is the weather of a place averaged over a **long period** (many years, usually about 30 years)."},
    {k:"p", t:"Liberia has a **hot and wet climate**, with a rainy season and a dry season."},
    {k:"rule"},
    {k:"h3", t:"Elements of Weather"},
    {k:"p", t:"The elements of weather are **temperature, rainfall, humidity, wind, sunshine, cloud cover, and air pressure**."},
    {k:"bul", items:["A **thermometer** measures temperature.","A **rain gauge** measures rainfall.","A **barometer** measures air pressure.","An **anemometer** measures the speed of the wind, and a **wind vane** shows its direction."]},
    {k:"rule"},
    {k:"h3", t:"The Apparent Movement of the Sun"},
    {k:"p", t:"The sun appears to move between the **Tropic of Cancer** (north) and the **Tropic of Capricorn** (south) during the year."},
    {k:"p", t:"When the sun is overhead in our region, the land heats up and the **rainy season** becomes strong; when it moves away, the **dry season** and the harmattan winds come."},
    {k:"rule"},
    {k:"h3", t:"Rainfall and Its Causes"},
    {k:"p", t:"The two main types of rainfall are:"},
    {k:"num", items:["**Convectional rainfall** – the sun heats the land and the sea; warm moist air rises, cools, and falls as rain. This is the common type in Liberia.","**Relief rainfall** – moist wind is forced to climb over mountains; it cools on the slope and drops its rain."]},
    {k:"rule"},
    {k:"h3", t:"Effects of Climate Change on Human Activities"},
    {k:"p", t:"**Climate change** is the unusual change of the climate over time. It affects:"},
    {k:"bul", items:["**Crop production** – irregular rains spoil planting and harvests.","**Beaches** – rising sea water eats away the coast.","**Roads** – heavy floods wash roads and bridges away.","**Mining** – floods and bad weather stop mining work."]}
...
},
{
  ...
  study:[
    /* ---- verbatim-style course text: Semester One, Period III ---- */
    {k:"h3", t:"Farming Methods in Liberia"},
    {k:"p", t:"**Subsistence farming** is growing food mainly to feed the farmer's family, using simple tools and family labor."},
    {k:"p", t:"**Commercial farming** is growing crops or rearing animals in large quantities for sale, using more machines and workers."},
    {k:"rule"},
    {k:"h3", t:"Factors That Influence Agricultural Production"},
    {k:"bul", items:["**Drought** – long periods without rain reduce harvests.","**Soil conditions** – poor soil gives poor crops.","**Erosion** – washing away of topsoil by rain and wind.","**Farm implements** – good tools and machines increase production.","**Fertilizers and chemicals** – they improve the soil and protect crops.","**Farm-to-market roads** – good roads carry farm produce to the market before it spoils."]},
    {k:"rule"},
    {k:"h3", t:"The Rubber Industry and Its Contributions"},
    {k:"p", t:"The big rubber plantations of Liberia are **Firestone**, the **Liberian Agricultural Company (LAC)**, and **Salala and Weala**."},
    {k:"p", t:"The rubber industry contributes **jobs**, **export money**, **roads**, and **schools and hospitals** for workers and their communities."},
    {k:"p", t:"The **oil palm industry** also produces palm oil and kernel for food, soap, and export."},
    {k:"rule"},
    {k:"h3", t:"Crops Cultivated in Liberia"},
    {k:"bul", items:["**Food crops** – rice, cassava, yam, eddoes, sweet potatoes, plantain and vegetables.","**Cash crops** – cocoa, coffee, oil palm and sugarcane, grown for sale.","**Commercial (export) crops** – rubber and oil palm grown on large plantations."]},
    {k:"rule"},
    {k:"h3", t:"Animal Husbandry and Aquaculture"},
    {k:"p", t:"**Animal husbandry** is the rearing and care of farm animals such as **poultry (fowls, ducks)** and **cattle**, done in **traditional** or **modern** ways."},
    {k:"p", t:"**Aquaculture** is the farming of **fish and other water animals** in ponds, rivers and lakes; **artisanal fishery** is small-scale fishing and **inland fishery** is fishing in rivers and lakes."},
    {k:"p", t:"The difference is simple: animal husbandry rears **land animals**, while aquaculture rears **water animals**."},
    {k:"rule"},
    {k:"h3", t:"Sex and Gender in Agriculture"},
    {k:"p", t:"**Sex** is the biological make-up of boys and girls; **gender** is the social roles that the society gives to men and women."},
    {k:"p", t:"In farming, women do much of the planting, weeding and harvesting, while men often clear the land and do the heavy work; **unequal gender roles** can hurt the well-being of women and girls, so work and benefits should be shared fairly."}
...
},
{
  ...
  study:[
    /* ---- verbatim-style course text: Semester Two, Period IV ---- */
    {k:"h3", t:"Mineral Resources of Liberia"},
    {k:"p", t:"The main **mineral resources** of Liberia are **iron ore, gold, diamonds, and rocks** (used for building and roads)."},
    {k:"rule"},
    {k:"h3", t:"Forest Resources"},
    {k:"p", t:"The forests give **timber** (hardwoods for building and export), **wildlife**, and **animals** that provide food and income."},
    {k:"rule"},
    {k:"h3", t:"Water Resources"},
    {k:"p", t:"The water resources of Liberia include **fish**, **hydro-electricity** (power from falling water), **off-shore oil**, and **sand** for building."},
    {k:"rule"},
    {k:"h3", t:"Renewable and Non-renewable Resources"},
    {k:"p", t:"**Renewable resources** can replace themselves after use, such as **water, forests, fish, and animals**, if they are used carefully."},
    {k:"p", t:"**Non-renewable resources** do not replace themselves once used, such as **iron ore, gold, diamonds, and oil**; they must not be wasted."},
    {k:"rule"},
    {k:"h3", t:"Contributions of Natural Resources to the Economy"},
    {k:"p", t:"Natural resources give **jobs**, bring **export money**, attract **companies**, and pay for **roads, schools and hospitals**."},
    {k:"rule"},
    {k:"h3", t:"Social Impact, Peer Influence and Artisanal Mining"},
    {k:"p", t:"**Social impact** is the effect an activity has on people and their way of life; **peer influence** is the way friends of the same age shape our choices, for good or for bad."},
    {k:"p", t:"**Artisanal mining** (small-scale mining by hand) can bring money, but it also pulls learners **out of school** and exposes them to dangers."},
    {k:"bul", items:["Health hazards in mining areas include **STIs and HIV/AIDS** and **work-related accidents**.","Hazards in mining, logging, hunting, fishing and hydro works must be reduced with **protective rules and equipment**."]}
...
},
{
  ...
  study:[
    /* ---- verbatim-style course text: Semester Two, Period V ---- */
    {k:"h3", t:"Population Pattern of Liberia"},
    {k:"p", t:"**Population density** is the number of people living per square kilometer of land."},
    {k:"p", t:"**Population growth** is the increase in the number of people over time; **population distribution** is how people are spread across the country."},
    {k:"p", t:"In Liberia, more people live along the **coast and in the towns**, while the interior is less crowded."},
    {k:"rule"},
    {k:"h3", t:"Population and National Development"},
    {k:"bul", items:["A high **birth rate** can slow development when there are not enough schools, clinics and jobs; it also affects **infant mortality** (deaths of babies) and **morbidity** (sickness).","**Urban and rural migration** moves people between the towns and the villages.","**Population control** means planning the size and growth of the population so that development can keep pace."]},
    {k:"rule"},
    {k:"h3", t:"Urban and Rural Settlements"},
    {k:"p", t:"An **urban settlement** is a town or city with many people, markets, offices and services (for example **Monrovia, Buchanan, Gbarnga, Ganta**)."},
    {k:"p", t:"A **rural settlement** is a village or small community where most people farm, fish or hunt."},
    {k:"rule"},
    {k:"h3", t:"Problems of Rural-Urban Migration"},
    {k:"bul", items:["Overcrowding and **slums** in the cities.","**Unemployment** and crime.","Pressure on **schools, clinics, water and roads**.","Fewer young workers left in the villages to farm."]},
    {k:"rule"},
    {k:"h3", t:"Vulnerability to Teenage Pregnancy and Substance Abuse"},
    {k:"p", t:"Young people become vulnerable to **unintended pregnancy** through **unprotected sex, peer pressure, drugs and alcohol abuse, and risky decisions**."},
    {k:"p", t:"Risky behaviors include **drug and alcohol abuse, multiple sex partners, use of pornographic materials, and yielding to negative peer pressure**."},
    {k:"p", t:"Teenage pregnancy can be prevented by **abstinence** and **protected sex**, and by holding strong **personal and family values**."}
...
},
{
  ...
  study:[
    /* ---- verbatim-style course text: Semester Two, Period VI ---- */
    {k:"h3", t:"Forms of Government"},
    {k:"bul", items:["**Democracy** – the people rule through free elections.","**Republican** – the head of state is an elected president, not a king.","**Monarchy** – a king or queen rules, sometimes with a constitution.","**Totalitarianism** – the state controls every part of life and allows no opposition.","**Autocracy** – one person holds all power.","**Feudalism** – lords own the land and the people serve them.","**Communism** – the state owns the means of production and shares them out.","**Military rule** – the armed forces take over the government."]},
    {k:"p", t:"Liberia is a **democratic republic**."},
    {k:"rule"},
    {k:"h3", t:"Branches and Functions of the Liberian Government"},
    {k:"num", items:["**Executive** – carries out the laws; headed by the **President**, who appoints ministers, judges and county officials with the Senate's consent.","**Legislative** – makes the laws; made of the **Senate** and the **House of Representatives**.","**Judiciary** – interprets the laws; made of the **courts**, with the **Supreme Court** at the top."]},
    {k:"rule"},
    {k:"h3", t:"Municipal Government"},
    {k:"p", t:"**Municipal government** is the local administration of cities and counties, run by **mayors and superintendents/municipal governors**."},
    {k:"p", t:"Its duties are to keep the city **clean and orderly**, collect **taxes and fees** (its sources of income), maintain **markets, streets and public facilities**, and serve the people."},
    {k:"rule"},
    {k:"h3", t:"The Liberian Court System"},
    {k:"p", t:"The courts of Liberia include the **Justice of the Peace courts, Magisterial courts, Civil and Debt courts, Circuit courts, Juvenile courts**, and the **Supreme Court**."},
    {k:"p", t:"The elements of a court case are:"},
    {k:"bul", items:["**Plaintiff** – the person who brings the case.","**Defendant** – the person accused.","**Jury** – citizens who decide the facts.","**Verdict** – the decision of the court or jury.","**Bail** – money or promise that frees an accused person until trial.","**Sentence** – the punishment given after a guilty verdict."]},
    {k:"rule"},
    {k:"h3", t:"Pressure Groups and Public Corporations"},
    {k:"p", t:"A **pressure group** is an organized body that tries to influence the government. Examples are the **Market Associations, the Federation of Transportation Unions, the National Labor Union, the National Teachers Association, civil society, and political parties**."},
    {k:"p", t:"**Public corporations** are businesses owned by the government to serve the people, such as the **Liberia Electricity Corporation (LEC), the Liberia Water & Sewer Corporation (LWSC), the Liberia Broadcasting System (LBS), and the National Housing Authority (NHA)**; **private corporations** are owned by individuals or companies."}
...
/* ================================ GRADE 9 ================================ */
{
  ...
  study:[
    /* ---- verbatim-style course text: Semester One, Period I ---- */
    {k:"h3", t:"The West African Region"},
    {k:"p", t:"West Africa is the western part of the African continent. The sixteen countries studied are:"},
    {k:"bul", items:["**On the Atlantic coast (west):** Senegal, The Gambia, Guinea-Bissau, Guinea, Sierra Leone, and Liberia.","**In the middle of the coast:** Côte d'Ivoire, Ghana, Togo, Benin, and Burkina Faso.","**In the east and the interior:** Nigeria, Cameroon, Niger, Mali, and Mauritania."]},
    {k:"rule"},
    {k:"h3", t:"Topography and Climate of the Region"},
    {k:"p", t:"Near the coast (Liberia, Sierra Leone, Guinea, southern Côte d'Ivoire, Ghana, Nigeria and Cameroon) the land is low with **rainforests**, and the climate is **hot and very wet**."},
    {k:"p", t:"Moving north, the land rises into **savanna** grassland with a shorter rainy season, and in the far north (Mali, Niger, Mauritania, northern Senegal) it becomes the dry **Sahel** and the **Sahara Desert**."},
    {k:"p", t:"Important highlands include the **Fouta Djallon** in Guinea, the **Jos Plateau** in Nigeria, and **Mount Cameroon**, the highest peak in the region."},
    {k:"rule"},
    {k:"h3", t:"Factors That Influence Weather and Climate"},
    {k:"bul", items:["**Distance from the equator** – places nearer the equator are hotter and wetter.","**Altitude (relief)** – higher places are cooler and can get relief rainfall.","**Distance from the sea** – coastal areas receive more rain.","**Winds** – the moist south-west monsoon brings rain; the dry **harmattan** from the Sahara brings dust and dryness.","**Ocean currents and vegetation cover** also affect the climate."]},
    {k:"rule"},
    {k:"h3", t:"Using Meteorological Instruments"},
    {k:"p", t:"Weather is measured with instruments: the **thermometer** (temperature), the **barometer** (air pressure), the **rain gauge** (rainfall), the **hygrometer** (humidity), the **anemometer** (wind speed), and the **wind vane** (wind direction)."},
    {k:"rule"},
    {k:"h3", t:"Major Industries of West Africa"},
    {k:"bul", items:["**Agriculture** – cocoa in Ghana and Côte d'Ivoire; groundnuts in Senegal and Nigeria; rice and cassava everywhere.","**Forestry** – timber from the rainforest belt.","**Mining** – gold in Ghana and Mali; diamonds in Sierra Leone and Liberia; iron ore in Liberia and Mauritania; oil in Nigeria and Cameroon.","**Fishery** – along the Atlantic coast and in the rivers and lakes.","**Manufacturing and tourism** – growing in the big cities."]},
    {k:"rule"},
    {k:"h3", t:"Communication and Transport Routes"},
    {k:"p", t:"West Africa is linked by **the old trans-Saharan routes**, **coastal shipping**, **the River Niger**, **roads**, **airports**, and today **radio, telephone, and internet**."},
    {k:"p", t:"These routes carry trade, people, and ideas, but they face **challenges** such as poor roads, high costs, and weak networks in rural areas."}
...
},
{
  ...
  study:[
    /* ---- verbatim-style course text: Semester One, Period II ---- */
    {k:"h3", t:"Forest Products and Major Industries"},
    {k:"p", t:"The forests of West Africa give **timber, rubber, cocoa, oil palm, and shea nuts**, and they shelter wildlife."},
    {k:"p", t:"Major industries built on these products are **saw-milling, rubber processing, cocoa processing, and palm-oil production**."},
    {k:"rule"},
    {k:"h3", t:"Geographical Factors Favoring Agriculture"},
    {k:"bul", items:["**Fertile soils** on the coastal plains and river valleys.","**Heavy rainfall** in the south for crops, and **grassland** in the north for cattle, sheep and goats.","**Rivers** (Niger, Senegal, Volta) for irrigation and fishing.","**Strong sunshine** all year round for growing crops.","**A large population** that provides farm workers and buyers."]},
    {k:"rule"},
    {k:"h3", t:"Major Minerals and Their Contributions"},
    {k:"p", t:"The major minerals of West Africa are **oil and gas (Nigeria, Cameroon), gold (Ghana, Mali, Burkina Faso), diamonds (Sierra Leone, Liberia, Guinea), iron ore (Liberia, Mauritania), and bauxite (Guinea)**."},
    {k:"p", t:"Their contributions to socio-economic development are:"},
    {k:"bul", items:["They bring **foreign exchange** when exported.","They give **jobs** in mines and related services.","They provide **government revenue** for schools, roads and hospitals.","They attract **industries and towns** around the mining areas."]}
...
},
{
  ...
  study:[
    /* ---- verbatim-style course text: Semester One, Period III ---- */
    {k:"h3", t:"Peoples and Ethnic Groups of West Africa"},
    {k:"p", t:"West Africa is home to hundreds of **ethnic groups**. Major ones include the **Hausa, Yoruba and Igbo** of Nigeria; the **Akan** of Ghana; the **Wolof** of Senegal; the **Mande peoples** (Mandingo, Kpelle, Loma and others) of Mali, Guinea and Liberia; the **Ewe** of Togo and Ghana; and the **Fulani** who live across the Sahel."},
    {k:"rule"},
    {k:"h3", t:"Life Styles and Occupations"},
    {k:"p", t:"Most West Africans in the villages are **farmers, fishers, herders, and craft makers**; in the towns people are also **traders, teachers, drivers, and office workers**."},
    {k:"p", t:"The **life style** of a people — how they dress, eat, marry, and celebrate — comes from their **culture**, so ways of life differ from place to place yet share much in common."},
    {k:"rule"},
    {k:"h3", t:"Occupation and Trade, and Common Problems"},
    {k:"p", t:"Trade joins West Africa together: goods move between the forest, the savanna and the desert, and between countries."},
    {k:"p", t:"Common problems of trade and communication are **poor roads, different currencies, border delays, and different official languages**; the solutions are **better infrastructure, ECOWAS cooperation, and free movement of people and goods**."},
    {k:"rule"},
    {k:"h3", t:"HIV/AIDS"},
    {k:"p", t:"HIV spreads through **unprotected sex, multiple sex partners, sex with older partners, unsterilized instruments, transfusion of infected blood, and drug abuse (sharing needles)**."},
    {k:"p", t:"It is prevented by **abstinence, faithful protected sex, and sterile instruments**. People living with HIV (**PLHIV**) can **live positively** with care and medicine, and must not be stigmatized."},
    {k:"rule"},
    {k:"h3", t:"The Family Life Cycle"},
    {k:"p", t:"The family life cycle has stages:"},
    {k:"num", items:["**Founding stage** – marriage and the start of the family.","**Expansion stage** – the birth and raising of children.","**Dispersion (launching) stage** – the children grow up and leave to start their own families.","**Retirement stage** – the parents rest in old age and are cared for."]},
    {k:"p", t:"Each stage has its own **roles and duties**, and understanding them keeps the family strong."},
    {k:"rule"},
    {k:"h3", t:"Gender Bias, Discrimination and GBV"},
    {k:"p", t:"**Gender bias** is treating one sex as less important than the other; **discrimination** is the unfair treatment that follows it. They happen **at home, at school, and in the community**."},
    {k:"p", t:"**Gender-based violence (GBV)** is violence directed at a person because of their sex; **domestic violence** hurts the whole family and community."},
    {k:"p", t:"GBV cases must be **reported**, survivors must be **cared for**, and everyone must learn **respect and equality** to end it."}
...
},
{
  ...
  study:[
    /* ---- verbatim-style course text: Semester One, Period IV ---- */
    {k:"h3", t:"The Sixteen Countries and Their Capitals"},
    {k:"bul", items:["**Senegal** – Dakar; **The Gambia** – Banjul; **Guinea-Bissau** – Bissau; **Liberia** – Monrovia; **Guinea** – Conakry; **Sierra Leone** – Freetown.","**Burkina Faso** – Ouagadougou; **Côte d'Ivoire** – Yamoussoukro; **Ghana** – Accra; **Togo** – Lomé; **Benin** – Porto-Novo.","**Nigeria** – Abuja; **Cameroon** – Yaoundé; **Niger** – Niamey; **Mali** – Bamako; **Mauritania** – Nouakchott."]},
    {k:"rule"},
    {k:"h3", t:"Land Forms: Mountains, Rivers and Lakes"},
    {k:"bul", items:["**Rivers** – the Niger, the Senegal, the Gambia, and the Volta are the great rivers of the region.","**Lakes** – **Lake Volta** in Ghana is one of the largest man-made lakes in the world; **Lake Chad** lies at the edge of the region.","**Mountains and highlands** – Mount Cameroon, the Fouta Djallon, the Jos Plateau, and Mount Nimba."]},
    {k:"p", t:"These land forms give **water, fish, power, transport, and rain**, and they shape where people live and farm."},
    {k:"rule"},
    {k:"h3", t:"Natural Resources, Vegetation and Land Use"},
    {k:"p", t:"The **rainforest zone** grows timber, cocoa, rubber and oil palm; the **savanna zone** grows grains and rears cattle; the **Sahel and desert zone** rears camels and goats and trades salt and dates."},
    {k:"p", t:"Key minerals by country: **oil – Nigeria and Cameroon; gold – Ghana and Mali; diamonds – Sierra Leone and Liberia; iron ore – Liberia and Mauritania; bauxite – Guinea; cocoa – Côte d'Ivoire and Ghana**."},
    {k:"rule"},
    {k:"h3", t:"Population Distribution, Cities and Seaports"},
    {k:"p", t:"People are most crowded **along the coast, along the great rivers, and in the big trading cities**, while the desert interior is thinly populated."},
    {k:"p", t:"Major cities include **Lagos, Abidjan, Accra, Dakar, Kano, Bamako and Monrovia**; great seaports are **Lagos, Tema, Abidjan, Dakar, Freetown and Monrovia**, which carry the region's trade."},
    {k:"rule"},
    {k:"h3", t:"Political Structures and Problems of Development"},
    {k:"p", t:"Nearly all the countries are **republics with elected presidents and parliaments**, and most belong to **ECOWAS**, the Economic Community of West African States."},
    {k:"p", t:"Common problems of development are **poverty, weak roads and power, dependence on raw-material exports, and political instability**; the solutions are **regional cooperation, education, and building industries that add value to our own resources**."}
...
},
{
  ...
  study:[
    /* ---- verbatim-style course text: Semester Two, Period V ---- */
    {k:"h3", t:"The History of West Africa and the European Myth"},
    {k:"p", t:"European colonial powers once claimed that **Africa had no history**. This is a **myth**."},
    {k:"p", t:"Africa's history is recorded in **oral tradition, archaeology, local written records, and the accounts of Arab and other travelers**; West Africa built great empires and cities long before Europeans arrived."},
    {k:"rule"},
    {k:"h3", t:"Pre-history: The Stone Age and Its Revolutions"},
    {k:"p", t:"In the **Old Stone Age** people used rough stone tools and lived by **hunting and gathering**."},
    {k:"p", t:"In the **New Stone Age** came the great revolution: people learned **farming, the domestication of animals, pottery, and settled village life**."},
    {k:"p", t:"Later, West Africans learned **iron smelting**, which gave better tools and weapons and changed farming and war."},
    {k:"rule"},
    {k:"h3", t:"The Nok Culture"},
    {k:"p", t:"The **Nok culture** flourished in present-day Nigeria from about **500 BC to 200 AD**."},
    {k:"p", t:"It is famous for its beautiful **terracotta (burnt-clay) sculptures** and for some of the earliest **iron smelting** in Africa, proving the deep civilization of West Africa."},
    {k:"rule"},
    {k:"h3", t:"Cultural Heritage of West Africa"},
    {k:"p", t:"The cultural heritage of West Africa includes **music and drumming, dance, sculpture and masks, weaving (kente and country cloth), proverbs and oral tradition, and great festivals**."},
    {k:"p", t:"It is different from the cultures of other continents, yet it has always exchanged ideas with them."},
    {k:"rule"},
    {k:"h3", t:"Major Tribes and Ethnic Groups, and Geographical Zones"},
    {k:"p", t:"The major ethnic groups live across the region's **geographical zones**, from south to north:"},
    {k:"num", items:["**The forest zone** – Akan, Ewe, Yoruba, Igbo, Mande forest peoples.","**The savanna zone** – Hausa, Fulani, Malinke, Mossi.","**The Sahel and desert zone** – Tuareg, Fulani, and Moorish herders and traders."]},
    {k:"p", t:"Each zone shaped the **food, work, dress, and trade** of its people."}
...
},
{
  ...
  study:[
    /* ---- verbatim-style course text: Semester Two, Period VI ---- */
    {k:"h3", t:"Origins of the Early West African States"},
    {k:"p", t:"The early states grew from **farming villages and trading towns** that became rich on the **trans-Saharan trade** in **gold, salt, kola, and cloth**. The four great states were **Ghana, Mali, Songhai, and Kanem-Bornu**."},
    {k:"rule"},
    {k:"h3", t:"The Ghana Empire"},
    {k:"p", t:"Ghana, the earliest, was called the **land of gold**; its kings taxed the gold and salt that crossed the desert, and its capital was **Kumbi Saleh**."},
    {k:"p", t:"It fell because of **Almoravid attacks, drought, and the loss of its trade routes**."},
    {k:"rule"},
    {k:"h3", t:"The Mali Empire"},
    {k:"p", t:"Mali was founded by **Sundiata Keita** after the battle of Kirina; its most famous ruler was **Mansa Musa**, whose **pilgrimage to Mecca in 1324** showed the world the empire's gold."},
    {k:"p", t:"Under Mali, **Timbuktu** became a great city of learning, with the **Sankore** school and mosque."},
    {k:"rule"},
    {k:"h3", t:"The Songhai Empire"},
    {k:"p", t:"Songhai, with its capital at **Gao**, rose under **Sunni Ali** and was organized into a strong state by **Askia Muhammad**, who also made the pilgrimage to Mecca."},
    {k:"p", t:"It fell in **1591** when an army from **Morocco with gunpowder weapons** invaded."},
    {k:"rule"},
    {k:"h3", t:"The Kanem-Bornu Empire"},
    {k:"p", t:"Kanem-Bornu grew around **Lake Chad** and lasted for many centuries, rich from the **salt, horse, and trans-Saharan trade**, with **Islam** as the religion of the court."},
    {k:"rule"},
    {k:"h3", t:"Achievements, and the Rise and Fall of the Empires"},
    {k:"p", t:"Their **achievements** were: great **trade and wealth**, **learning and libraries at Timbuktu**, **strong administration and justice**, and **fine architecture and art**."},
    {k:"p", t:"They **rose** through **strong rulers, control of the gold-salt trade, powerful armies, and unity**; they **fell** through **weak successors, internal revolts, foreign invasion, and the loss of trade**."},
    {k:"rule"},
    {k:"h3", t:"The Family Life Cycle and Good Health"},
    {k:"p", t:"At every stage of the **family life cycle** — founding, expansion, dispersion, and retirement — good health practices (cleanliness, good feeding, immunization, and care for mothers and the elderly) keep the family strong and able to reach its goals."}
