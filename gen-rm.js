/* Religious & Moral Education exercise generation engine.
   Emits the SAME block model as the English, French, Science and Maths engines,
   so the shared renderer and .docx exporter are reused. Registered on window.GEN_RM. */
(function (root) {
  "use strict";
  ...
  /* H · Compare and contrast — the two faiths side by side */
  function wsCompare(t) {
    ...
    return {
      blocks: [
        ...
        { k: "instr", t: d.caption + " Write about every faith with respect." },
        { k: "table", head: ["Point of comparison", "What it means / what each faith teaches"],
  ...
  function wsApply(t, n, r) {
    ...
    return {
      blocks: [
        { k: "h3", t: "J · Think and Apply — Moral Reasoning" },
  ...
  function wsProject(t) {
    ...
    return {
      blocks: [
        ...
        { k: "instr", t: p.brief + " Work carefully, and be polite and respectful to everybody you speak with, whatever their faith." },
  ...
  function wsJournal(t) {
    return {
      blocks: [
        { k: "h3", t: "L · My Religious & Moral Education Journal" },
        ...
        { k: "lines", n: 3 },
        { k: "p", t: "3. One teaching from this unit that I want to remember:" },
        { k: "lines", n: 2 },
        { k: "p", t: "4. One thing I learned about the faith of my neighbour, and one thing I respect about it:" },
        { k: "lines", n: 3 },
        { k: "p", t: "5. One thing I will do differently at home or at school because of this unit:" },
        { k: "lines", n: 3 },
        { k: "p", t: "6. A prayer, a good wish or a resolution in my own words:" },
        { k: "lines", n: 3 }
      ],
      key: ["Open response. Award marks for correct use of key terms, an accurate statement of a teaching, evidence of respect for the other faith, and one specific, realistic personal resolution."]
    };
  }
  ...
  function wsDebate(t, n, r) {
    ...
    return {
      blocks: [
        ...
        { k: "instr", t: "Work in mixed groups. Choose ONE question. Half the group argues FOR and half AGAINST. Rule: before you argue against the other side, you must first state their view so fairly that they agree you have stated it correctly. No insulting of any faith." },
        { k: "num", items: sel.map(function (v) { return v.q; }) },
        { k: "space" },
  ...
  function semesterExam(topics, sem, r) {
    ...
    blocks.push({ k: "h2", t: "SEMESTER " + sem.toUpperCase() + " EXAMINATION — GRADE " + g + " RELIGIOUS & MORAL EDUCATION" });
    blocks.push({ k: "table", head: ["Name", "Class", "Date", "Score"],
    ...
    sec("SECTION A — Religious & Moral Education vocabulary", "Write the meaning of each term.",
    ...
    if (mp) {
      blocks.push({ k: "instr", t: "1. Complete the comparison: " + mp.title + ". For each point below, state clearly what it means or what each faith teaches. Write with respect. (6 marks)" });
  ...
  function buildPack(opts) {
    ...
    var topics = RM_CURRICULUM.filter(function (t) {
      return t.grade === opts.grade && (!opts.topics || opts.topics.indexOf(t.period) >= 0);
    });
    var doc = [], keys = [], toc = [];

    doc.push({ k: "h1", t: "RELIGIOUS & MORAL EDUCATION — GRADE " + opts.grade });
    doc.push({ k: "h2", t: "Pupil Workbook & Assessment Pack" });
    doc.push({ k: "p", t: "Elementary Religious & Moral Education · Liberian National Curriculum", i: true });
    doc.push({ k: "space" });
    ...
    doc.push({ k: "bul", items: [
      ...
      "This is a multi-religious course. State the teaching of every faith accurately and respectfully.",
      "Before you disagree with a belief, first state it so fairly that its holders would agree.",
  ...
  root.GEN_RM = { buildPack: buildPack, SHEETS: SHEETS };
})(window);
